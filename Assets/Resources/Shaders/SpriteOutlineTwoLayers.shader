...
Shader "Sprites/TwoLayersGlow"
{
    Properties
    {
		[PerRendererData]_MainTex("Sprite Texture", 2D) = "white" {}

		_MainTexGlow("Sprite Texture Glow", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex, _AlphaTex, _MainTexGlow;
            float4 _MainTex_TexelSize, _MainTexGlow_TexelSize;
            fixed4 _Color;
			...
			fixed4 SampleSpriteGlowTexture(float2 uv)
			{
				fixed4 color = tex2D(_MainTexGlow, uv);
            ...
            fixed4 ComputeFragment(VertexOutput vertexOutput) : SV_Target
            {
				...
				color = color + SampleSpriteGlowTexture(vertexOutput.TexCoord)* vertexOutput.Color;
                color.rgb *= color.a;
                return color;
            }
